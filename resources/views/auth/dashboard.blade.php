  ...
  <div class="offcanvas offcanvas-start bg-purple text-white sidebar-nav" tabindex="-1" id="offcanvasExample"
    ...
    <div class="offcanvas-header shadow-sm d-block text-center">
      <div class="offcanvas-title" id="offcanvasExampleLabel">
        <a class="navbar-brand fw-bold" href="{{ route('hrdasboard')  }}>
      ...
      <nav class="navbar-dark">
        <ul class="navbar-nav sidenav">
          <li class="nav-link bordered px-3 active">
            <a href="{{ route('userprofile')  }}" class="nav-link px-3 active">
              @if(session()->has('user'))
            ...
            <div class="collapse" id="collapseExample">
              <div>
                <ul class="navbar-nav ps-3">
                  <li>
                    <a id='add_exp' href="{{ route('experience-page')  }}" class="nav-link px-3">
                  ...
                  <li>
                    <a id='all_exp' href="{{ route('experience-page')  }}" class="nav-link px-3">
  ...
  <main class="mt-3 p-2">
    <div class="container">
      ...
      <div class="latest-added mt-5">
          @if(session()->has('approval_request') && count(session('approval_request')) > 0)
        ...
        <div class="card border-0 shadow-sm">
          <div class="card-body">
            ...
            <table id="datatable" class="table table-striped table-bordered" style="width:100%">
              ...
              @foreach (session('approval_request') as $req)
              <tr>
