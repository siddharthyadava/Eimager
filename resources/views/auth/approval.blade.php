  ...
  <div class="offcanvas offcanvas-start bg-purple text-white sidebar-nav" tabindex="-1" id="offcanvasExample"
    ...
    <div class="offcanvas-header shadow-sm d-block text-center">
      <div class="offcanvas-title" id="offcanvasExampleLabel">
        <!-- <a class="navbar-brand fw-bold" href="index.html">EImager</a> -->
        <a class="navbar-brand fw-bold" href="{{ route('userprofile-page')  }}">
            ...
            <div class="collapse" id="collapseExample">
              <div>
                <ul class="navbar-nav ps-3">
                  <li>
                    <a id='add_exp' href="#" class="nav-link px-3">
                  ...
                  <li>
                    <a id='all_exp' href="#" class="nav-link px-3">
  ...
  <main class="mt-3 p-2">
    <div class="container">
      <div class="page-title">
        <div style="font-weight: 500;" class="fs-3">Approvals</div>
      </div>
